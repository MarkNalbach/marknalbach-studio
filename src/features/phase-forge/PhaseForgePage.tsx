      ...
      {showWinOverlay && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 px-4">
          <motion.div
            ...
            className="relative w-full max-w-md overflow-hidden rounded-[2rem] border border-cyan-300/30 bg-slate-950 p-6 text-center shadow-2xl shadow-cyan-950/40"
          >
            <div className="pointer-events-none absolute inset-0 opacity-30">
              <div className="absolute left-8 top-8 h-16 w-16 rounded-full bg-cyan-300 blur-2xl" />
              <div className="absolute bottom-10 right-10 h-20 w-20 rounded-full bg-emerald-300 blur-2xl" />
              <div className="absolute right-20 top-20 h-12 w-12 rounded-full bg-purple-300 blur-2xl" />
            </div>

            <div className="relative">
              <div className="mx-auto mb-5 flex h-20 w-20 items-center justify-center rounded-full border border-emerald-300/30 bg-emerald-300/10 text-4xl">
                🎉
              </div>
              ...
              <h2 className="mt-3 text-5xl font-black text-white">Nice Job!</h2>

              <p className="mt-4 text-slate-300">
                You completed the phase with a 4 of a Kind and a Run of 4.
              </p>
              ...
              <div className="mt-6 rounded-2xl border border-emerald-300/20 bg-emerald-300/10 p-4">
                ...
                <p className="mt-1 text-3xl font-black text-white">+10</p>
              </div>

              <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                <button
                  onClick={newGame}
                  className="flex-1 rounded-xl bg-cyan-300 px-5 py-3 text-sm font-bold text-slate-950 transition hover:bg-cyan-200"
                >
                  Play Again
                </button>
                ...
                <button
                  ...
                  className="flex-1 rounded-xl border border-white/15 bg-white/[.06] px-5 py-3 text-sm font-bold text-white transition hover:bg-white/10"
                >
                  Keep Looking
                </button>
              </div>
                ...
                return (
                  <div key={group.id} className="flex flex-col gap-2">
                    ...
                    >
                      ...
                      >
                        <div className="flex min-h-32 w-full items-center justify-start overflow-hidden px-0 py-2 sm:px-3">
                          {cards.length === 0 ? (
                            ...
                            cards.map((card, index) => {
                              ...
                              return (
                                <div
                                  ...
                                  className={`relative cursor-pointer transition-transform duration-150 scale-[0.8] sm:scale-100 ${
                                    index === 0 ? "" : "-ml-[3.5rem] sm:-ml-14 md:-ml-10"
                                  } ${isSel ? "-translate-y-3" : ""}`}
                                >
